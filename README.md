<picture>
  ...
  <img alt="Riley Nielsen — software engineer, St Paul MN. 300,000+ fare searches served, 176 stars on BorderlessMinecraft." src="./assets/card-dark.svg">
</picture>
...
<sub>The header card regenerates daily from the RailForLess and GitHub APIs — see <a href="./.github/workflows/refresh-card.yml">the workflow</a>.</sub>
